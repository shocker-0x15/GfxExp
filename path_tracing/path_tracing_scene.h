...
struct GPUEnvironment {
    ...
    void initialize() {
        ...
        // JP: ���̃T���v���ł�2�i�K��AS(1�i�K�̃C���X�^���V���O)���g�p����B
        ...
        defaultMaterial.setHitGroup(shared::RayType_PathTrace, pathTraceBaselineHitProgramGroup);
...
static GeometryInstance* createGeometryInstance(
    ...
    // JP: �ʐςɔ�Ⴕ�Ĕ����v���~�e�B�u���T���v�����O�ł���悤�C���|�[�^���X���v�Z����B
...
static Instance* createInstance(
    ...
    // JP: �e�W�I���g���C���X�^���X�̌����T���v�����O�Ɋւ��C���|�[�^���X��
    //     �v���~�e�B�u�̃C���|�[�^���X�̍��v�l�Ƃ���B
...
static void createTriangleMeshes(
    ...
    for (int matIdx = 0; matIdx < scene->mNumMaterials; ++matIdx) {
        ...
        if constexpr (useLambertMaterial) {
            ...
            // JP: �ɒ[�ɉs���X�y�L�����[�ɂ����NEE�Ŋ�^����؃T���v���ł��Ȃ��Ȃ��Ă��܂��B
        ...
        if (matConv == MaterialConvention::Traditional) {
            ...
            // JP: diffuse�e�N�X�`���[�Ƃ��ăx�[�X�J���[ + �s�����x
            //     specular�e�N�X�`���[�Ƃ��ăI�N���[�W�����A���t�l�X�A���^���b�N
            //     ���i�[����Ă���Ɖ��肵�Ă���B
