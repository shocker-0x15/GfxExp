...
int32_t main(int32_t argc, const char* argv[]) try {
    ...
    CUDADRV_CHECK(cuModuleLoad(&moduleCopyBuffers, (getExecutableDirectory() / "path_tracing/ptxes/copy_buffers.ptx").string().c_str()));
    ...
    drawOptiXResultShader.initializeVSPS(readTxtFile(exeDir / "path_tracing/shaders/drawOptiXResult.vert"),
