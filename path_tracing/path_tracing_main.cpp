...
struct GPUEnvironment {
    ...
    void initialize() {
...

        {
            ...
            p.setMissProgram(
                shared::PathTracingRayType::Closest, pipeline.programs.at(RT_MS_NAME_STR("pathTraceBaseline")));
            ...
            optixDefaultMaterial.setHitGroup(
                shared::PathTracingRayType::Closest, pipeline.hitPrograms.at(RT_CH_NAME_STR("pathTraceBaseline")));
            optixDefaultMaterial.setHitGroup(
